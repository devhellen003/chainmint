            ...
            t.canGoNext = b, t.extractObject = function(e, t) {
                ...
                if (i.swipeLength > g) {
                    ...
                    switch (w) {
                        case "left":
                        case "up":
                            j = P + S(t), T = d ? m(t, j) : j, O.currentDirection = 0;
                            break;
                        case "right":
                        case "down":
                            j = P - S(t), T = d ? m(t, j) : j, O.currentDirection = 1;
                            break;
                        default:
                            T = P
                    }
        ...
        91033: function(e, t, n) {
            ...
            var b = function() {
                ...
                ResizeObserver = function ResizeObserver(e) {
                    ...
                    if (!arguments.length) throw TypeError("1 argument required, but only 0 present.");
                    var t = new g(e, c.getInstance(), this);
                    m.set(this, t)
                };
            ...
            var S = void 0 !== o.ResizeObserver ? o.ResizeObserver : ResizeObserver;
            t.default = S
        },
        71169: function(e) {
            e.exports = function(e) {
